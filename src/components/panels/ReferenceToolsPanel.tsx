      ...
      <div className="flex-1 p-4 flex flex-col gap-2">
        {tools.map((t) => (
          <a
            ...
            className="flex items-center gap-3 p-2.5 border border-slate-200 rounded-lg hover:bg-indigo-50 hover:border-indigo-200 transition-colors group"
          >
            <span className="w-7 h-7 bg-indigo-100 text-indigo-700 rounded font-bold text-xs flex items-center justify-center group-hover:bg-indigo-200">
              {t.icon}
            </span>
